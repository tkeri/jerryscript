...
ecma_is_constructor (ecma_value_t value) /**< ecma value */
{
  ...
  if (likely(ecma_get_object_type (obj_p) == ECMA_OBJECT_TYPE_FUNCTION))
  {
                       ...
                       ecma_length_t arguments_list_len) /**< length of arguments list */
{
  ...
  if (likely(ecma_get_object_type (func_obj_p) == ECMA_OBJECT_TYPE_FUNCTION))
  {
                                               ...
                                               ecma_length_t arguments_list_len) /**< length of arguments list */
{
  ...
  /* 1., 2., 4. */
  ecma_object_t *obj_p;
  if (likely(ecma_is_value_object (func_obj_prototype_prop_value)))
  {
    /* 6. */
