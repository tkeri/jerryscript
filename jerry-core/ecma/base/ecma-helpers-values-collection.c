                                                           ...
                                                           decrement reference counter of the object */
{
  ...
  while (chunk_p != NULL)
  {
           ...
           && value_index < header_p->unit_number)
    {
      ...
      if (unlikely(do_deref_if_object))
      {
                                                              ...
                                                              increase reference counter of the object */
{
  ...
  if (unlikely((ecma_length_t) values_number == values_number))
  {
  ...
  if (unlikely(pos_of_new_value_in_chunk == 0))
  {
...
ecma_collection_iterator_next (ecma_collection_iterator_t *iterator_p) /**< context of iterator */
{
  if (iterator_p->header_p == NULL
      ||  (iterator_p->header_p->unit_number == 0)
      ||  (iterator_p->header_p->first_chunk_cp == JMEM_CP_NULL))
  {
    return false;
  }
